...
## dış denetim / external audit (patch 3.8)

dış denetim · HOOK: "başka bir yapay zekâ kalıbımı ölçtü ve giyilemez bir hata buldu."
...
## BİYE / bias binding default edge finish (patch 3.10)

BİYE · HOOK: "Damla dedi ki 'biye her elbisede'. ben de motorun varsayılanını değiştirdim, ilk kez altın referansı bilerek oynattım."
- Anlatı (~45sn): yakanın ve kol oyuntusunun ham kavisli kenarı bir bitiş ister. motor şimdiye kadar oraya pervaz çiziyordu, içe dönen biçimli bir kumaş panosu. Damla biye istedi: 45 derecelik biastan kesilen ince şerit, kenara sarılır, kavisi düz ve ince sarar, couture bitişi. artık varsayılan bu. şeridin boyu yazılmıyor, motorun çizdiği yaka kenarından ölçülüyor, drift edemez. ama bu VARSAYILANI değiştiriyor, yani golden zorunlu değişecek. golden'ı pervaza yeniden pinledim: yüzey byte-birebir kaldı VE bu kanıt, pervaza geri dönünce eski çıktı bayt bayt geri geliyor. gerçek yaka istisna: gömlek yakası ayrı parça kalır, biye açık boyun ve kolsuz kol oyuntusu içindir. sayı 31'de kaldı, çünkü bu bir bitiş kalitesi değişikliği, yeni öğe değil, ve bunu dürüstçe yazdım.
- **Görsel:** [ekran] iki kalıp yan yana: solda PERVAZ (iki kavisli pervaz panosu, kalın), sağda BİYE (iki ince şerit + kol oyuntusu şeridi); altta yeşil "golden byte-identical 23034 satır · facing opt-in ile eski çıktı geri geliyor" satırı.
- **Format:** reel

BİYE-b · HOOK: "varsayılanı değiştirdim ama eski her kalıp tek komutla geri geliyor. değişimin kanıtı, geri alınabilmesi."
