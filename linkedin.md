...
## Essay 21, "Damla 'biye her elbisede' dedi ve ben motorun varsayılanını değiştirdim, ilk kez altın referansı bilerek oynattım" (BİYE / patch 3.10)

1. **Bir müşteri sözü bir spec'tir.** Damla tek cümle söyledi: "yaka parçası istemiyorum, biye her elbisede." Terzilikte bu net bir karar: yakanın ve kol oyuntusunun ham kavisli kenarı bir bitiş ister. Motor şimdiye kadar oraya pervaz çiziyordu, içe dönen biçimli bir kumaş panosu. Damla'nın istediği biye: 45 derecelik biastan kesilip kenara sarılan ince bir şerit. Biastan kesildiği için esner, kavisi düz ve ince sarar; couture bir yakayı böyle bitirir. Yorumlamadım, kararı olduğu gibi motora taşıdım.

2. **Bu değişiklik altın referansı oynatıyor, ve bunu saklamadım.** Aylardır her loop'un kuralı şuydu: yeni bir kabiliyet ekle ama tek bir eski kalıp değişmesin, golden byte-birebir kalsın. Bu loop farklı: VARSAYILANI değiştiriyorum, pervaz yerine biye. Yani golden zorunlu olarak değişecek. Kolay yol sayıyı gizlemekti; dürüst yol golden'ı yeni bir eksende yeniden sabitlemek: golden dökümünü pervaza pinledim (Swift referansı biyeden önce, zaten pervaz çiziyordu). Sonuç: yüzey byte-birebir aynı kaldı, 0.000000 mm, 23034 satır, VE bu aynı zamanda kanıt: pervaza geri döndüğünde eski çıktı bayt bayt geri geliyor. "byte-identical" burada yetmezdi; "golden bilinçli değişti + pervazla eski çıktı geri geliyor" geçti.

3. **Truing: şeridin boyu yazılmaz, çizilen kenardan ölçülür.** Biye şeridinin uzunluğu, sardığı kenarın çevresine eşit olmalı. Bir sabit girmedim; motorun neckline'ı çizerken kullandığı AYNI komutları düzleştirip ölçtüm (ön yarım + arka yarım, katlı olduğu için iki katı). Böylece şerit, bağladığı kenardan drift edemez. Yeni bias_check her yaka için ölçüyor: crew 360 mm, scoop 420 mm, vNeck 450 mm, şerit boyu kenar + pay, milimetrenin yüzde biri hassasiyetinde. Tek doğru, tek yerde: yaka genişliği, kol oyuntusu, biye boyu, hepsi tek kaynaktan.

4. **İstisna gerçek yaka: biye açık boyun içindir, gömlek yakası için değil.** Karar "her elbisede biye" ama her boyun açık boyun değil. Gerçek bir yaka, kumaşın üstünde duran bir gömlek ya da dik yaka, biyeyle olmaz, kendi parçası olarak pervazlı bir boyunda durmalı. O yüzden motor şöyle ayırıyor: yakasız açık boyun → biye; gerçek collar → collar parçası + pervaz. Kol oyuntusu: kolsuz → biye; kollu → kol takılır, biye yok. Render-onayda gözle doğruladım: kolsuz elbise ince biye şeritleri aldı, gömlek yakasını ayrı parça olarak korudu.

5. **Sayı oynamadı, ve bu dürüst.** Biye bir bitiş kalitesi değişikliği, yeni çizilebilir bir öğe değil. Yaka ve kol oyuntusu ZATEN bitiyordu (önce pervazla, şimdi biyeyle), hiçbir fotoğrafın "eksik" listesinde değillerdi. O yüzden tam-kalıp sayısı 31'de kalıyor, ve patch notunda bunu açıkça yazdım. Bir sayıyı oynatmayan bir loop, ürünü gerçekten iyileştirebilir: her elbise artık daha ince, daha temiz bir kenarla bitiyor, ve bir dış denetimin "kolsuz garment'ta armhole bitişi yok" eksiği kapandı. 21 test geçiyor, 20260 web draft'ı sıfır hata, golden byte-birebir. Kanıtlıyorum, iddia etmiyorum.
