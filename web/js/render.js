...
import { fabricAdvice } from './fabrics.js?v=104';
import { getLang, t } from './i18n.js?v=104';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=104';
import { GUIDE_TR } from './guide-tr.js?v=104';
import { GLOSSARY } from './glossary.js?v=104';
import { appendSewingCompanion } from './sewing.js?v=104';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=104';
export { pathD, bounds };
