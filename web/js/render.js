...
import { fabricAdvice } from './fabrics.js?v=132';
import { getLang, t } from './i18n.js?v=132';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=132';
import { GUIDE_TR } from './guide-tr.js?v=132';
import { GLOSSARY } from './glossary.js?v=132';
import { appendSewingCompanion } from './sewing.js?v=132';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=132';
export { pathD, bounds };
