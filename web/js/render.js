...
import { fabricAdvice } from './fabrics.js?v=148';
import { getLang, t } from './i18n.js?v=148';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=148';
import { GUIDE_TR } from './guide-tr.js?v=148';
import { GLOSSARY } from './glossary.js?v=148';
import { appendSewingCompanion } from './sewing.js?v=148';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=148';
export { pathD, bounds };
