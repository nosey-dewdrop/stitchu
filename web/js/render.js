...
import { fabricAdvice } from './fabrics.js?v=118';
import { getLang, t } from './i18n.js?v=118';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=118';
import { GUIDE_TR } from './guide-tr.js?v=118';
import { GLOSSARY } from './glossary.js?v=118';
import { appendSewingCompanion } from './sewing.js?v=118';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=118';
export { pathD, bounds };
