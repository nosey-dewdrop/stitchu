...
import { fabricAdvice } from './fabrics.js?v=113';
import { getLang, t } from './i18n.js?v=113';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=113';
import { GUIDE_TR } from './guide-tr.js?v=113';
import { GLOSSARY } from './glossary.js?v=113';
import { appendSewingCompanion } from './sewing.js?v=113';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=113';
export { pathD, bounds };
