...
import { fabricAdvice } from './fabrics.js?v=119';
import { getLang, t } from './i18n.js?v=119';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=119';
import { GUIDE_TR } from './guide-tr.js?v=119';
import { GLOSSARY } from './glossary.js?v=119';
import { appendSewingCompanion } from './sewing.js?v=119';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=119';
export { pathD, bounds };
