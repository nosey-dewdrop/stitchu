...
import { fabricAdvice } from './fabrics.js?v=94';
import { getLang, t } from './i18n.js?v=94';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=94';
import { GUIDE_TR } from './guide-tr.js?v=94';
import { GLOSSARY } from './glossary.js?v=94';
import { appendSewingCompanion } from './sewing.js?v=94';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=94';
export { pathD, bounds };
