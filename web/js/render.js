...
import { fabricAdvice } from './fabrics.js?v=114';
import { getLang, t } from './i18n.js?v=114';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=114';
import { GUIDE_TR } from './guide-tr.js?v=114';
import { GLOSSARY } from './glossary.js?v=114';
import { appendSewingCompanion } from './sewing.js?v=114';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=114';
export { pathD, bounds };
