...
import { fabricAdvice } from './fabrics.js?v=92';
import { getLang, t } from './i18n.js?v=92';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=92';
import { GUIDE_TR } from './guide-tr.js?v=92';
import { GLOSSARY } from './glossary.js?v=92';
import { appendSewingCompanion } from './sewing.js?v=92';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=92';
export { pathD, bounds };
