...
import { fabricAdvice } from './fabrics.js?v=53';
import { getLang, t } from './i18n.js?v=53';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=53';
import { GUIDE_TR } from './guide-tr.js?v=53';
import { GLOSSARY } from './glossary.js?v=53';
...
import { pathD, bounds } from './sheet.js?v=53';
export { pathD, bounds };
