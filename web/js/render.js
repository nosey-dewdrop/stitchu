...
import { fabricAdvice } from './fabrics.js?v=117';
import { getLang, t } from './i18n.js?v=117';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=117';
import { GUIDE_TR } from './guide-tr.js?v=117';
import { GLOSSARY } from './glossary.js?v=117';
import { appendSewingCompanion } from './sewing.js?v=117';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=117';
export { pathD, bounds };
