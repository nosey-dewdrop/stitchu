...
import { fabricAdvice } from './fabrics.js?v=124';
import { getLang, t } from './i18n.js?v=124';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=124';
import { GUIDE_TR } from './guide-tr.js?v=124';
import { GLOSSARY } from './glossary.js?v=124';
import { appendSewingCompanion } from './sewing.js?v=124';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=124';
export { pathD, bounds };
