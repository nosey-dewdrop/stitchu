...
import { fabricAdvice } from './fabrics.js?v=133';
import { getLang, t } from './i18n.js?v=133';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=133';
import { GUIDE_TR } from './guide-tr.js?v=133';
import { GLOSSARY } from './glossary.js?v=133';
import { appendSewingCompanion } from './sewing.js?v=133';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=133';
export { pathD, bounds };
