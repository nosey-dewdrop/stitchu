...
import { analyzePhoto, photoAvailable } from './analyze.js?v=6';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=6';
import { draft } from './engine.js?v=6';
import { printPattern } from './print.js?v=6';
import { renderResult } from './render.js?v=6';
import {
