...
import { analyzePhoto, photoAvailable } from './analyze.js?v=121';
import { validateVision } from './spec-validate.js?v=121';
import { CONTRACT } from './contract.gen.js?v=121';
import { applyStatic, getLang, t } from './i18n.js?v=121';
import { draft, grade } from './engine.js?v=121';
import { printPattern, printGrade, printGradeNested } from './print.js?v=121';
import { renderResult } from './render.js?v=121';
import {
  MEASUREMENTS, loadMeasurements, saveMeasurements, saveToCloset,
  loadProfiles, saveProfile, deleteProfile,
} from './store.js?v=121';
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickHemFlounce, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat } from './vision-bridge.js?v=121';
