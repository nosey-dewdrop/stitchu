...
import { analyzePhoto, photoAvailable } from './analyze.js?v=3';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=3';
import { draft } from './engine.js?v=3';
import { printPattern } from './print.js?v=3';
import { renderResult } from './render.js?v=3';
import {
