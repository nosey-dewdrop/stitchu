...
import { analyzePhoto, photoAvailable } from './analyze.js?v=7';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=7';
import { draft } from './engine.js?v=7';
import { printPattern } from './print.js?v=7';
import { renderResult } from './render.js?v=7';
import {
