...
import { analyzePhoto, photoAvailable } from './analyze.js?v=131';
import { validateVision } from './spec-validate.js?v=131';
import { CONTRACT } from './contract.gen.js?v=131';
import { applyStatic, getLang, t } from './i18n.js?v=131';
import { draft, grade } from './engine.js?v=131';
import { printPattern, printGrade, printGradeNested } from './print.js?v=131';
...
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickHemFlounce, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat, refreshSkirtLengthMM, applyMeasuredRatios, pickSkirtFullness } from './vision-bridge.js?v=131';
import { measureGarment } from './measure.js?v=131';
