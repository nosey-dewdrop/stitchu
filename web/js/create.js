...
import { analyzePhoto, photoAvailable } from './analyze.js?v=133';
import { validateVision } from './spec-validate.js?v=133';
import { CONTRACT } from './contract.gen.js?v=133';
import { applyStatic, getLang, t } from './i18n.js?v=133';
import { draft, grade } from './engine.js?v=133';
import { printPattern, printGrade, printGradeNested } from './print.js?v=133';
import { renderResult } from './render.js?v=133';
import {
  MEASUREMENTS, loadMeasurements, saveMeasurements, saveToCloset,
  loadProfiles, saveProfile, deleteProfile,
} from './store.js?v=133';
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickHemFlounce, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat, refreshSkirtLengthMM, applyMeasuredRatios, pickSkirtFullness } from './vision-bridge.js?v=133';
import { measureGarment } from './measure.js?v=133';
