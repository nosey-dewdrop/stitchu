...
import { analyzePhoto, photoAvailable } from './analyze.js?v=115';
import { validateVision } from './spec-validate.js?v=115';
import { CONTRACT } from './contract.gen.js?v=115';
import { applyStatic, getLang, t } from './i18n.js?v=115';
import { draft, grade } from './engine.js?v=115';
import { printPattern, printGrade, printGradeNested } from './print.js?v=115';
import { renderResult } from './render.js?v=115';
import {
  MEASUREMENTS, loadMeasurements, saveMeasurements, saveToCloset,
  loadProfiles, saveProfile, deleteProfile,
} from './store.js?v=115';
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat } from './vision-bridge.js?v=115';
