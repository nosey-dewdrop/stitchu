...
import * as koken from './provenance.js?v=148';

import { pathD, bounds } from './sheet.js?v=148';
import * as sheet from './sheet.js?v=148';
import { makePdfCore } from '../lib/pdf-core.js?v=148';
import { dxfRecipe, dxfSpec, flatDrawing } from './engine.js?v=148';
...
import { arkaDurumu } from '../lib/arka-koken.js?v=148';
