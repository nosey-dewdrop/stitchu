...
import { applyFabricPreset } from './fabric-catalog.js?v=148';
...
export function loadEngine() {
  if (!enginePromise) {
    enginePromise = new Promise((resolve, reject) => {
      ...
      script.src = 'vendor/stitchu-engine.js?v=148';
...
import { CONTRACT } from './contract.gen.js?v=148';
import { renderFlatFromPattern } from '../lib/flat-from-pattern.js?v=148';
