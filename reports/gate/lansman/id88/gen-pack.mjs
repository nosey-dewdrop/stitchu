...
writeFileSync(join(OUT, 'id88-crew-dart-tank-a4.pdf'), buf);
...
info.push(`OUTPUT: id88-crew-dart-tank-a4.pdf — ${totalPages} pages (cover + test square + ${sheets.length} pattern sheet(s) + gluing/sew guide)`);
