...
const SPEC = {
  garment: 'top', shaping: 'princess', waistline: 'natural', fabric: 'woven',
  neckline: 'boat', sleeveStyle: 'none', sleeveLength: null,
...
writeFileSync(join(OUT, 'id23-boatneck-princess-top-a4.pdf'), buf);
...
info.push(`OUTPUT: id23-boatneck-princess-top-a4.pdf — ${totalPages} pages (cover + test square + ${sheets.length} pattern sheet(s) + gluing/sew guide)`);
