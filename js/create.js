...
import { analyzePhoto, photoAvailable } from './analyze.js?v=9';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=9';
import { draft } from './engine.js?v=9';
import { printPattern } from './print.js?v=9';
import { renderResult } from './render.js?v=9';
import {
