...
import { analyzePhoto, photoAvailable } from './analyze.js?v=34';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=34';
import { draft } from './engine.js?v=34';
import { printPattern } from './print.js?v=34';
import { renderResult } from './render.js?v=34';
import {
