...
import { analyzePhoto, photoAvailable } from './analyze.js?v=8';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=8';
import { draft } from './engine.js?v=8';
import { printPattern } from './print.js?v=8';
import { renderResult } from './render.js?v=8';
import {
