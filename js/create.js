...
import { analyzePhoto, photoAvailable } from './analyze.js?v=116';
import { validateVision } from './spec-validate.js?v=116';
import { CONTRACT } from './contract.gen.js?v=116';
import { applyStatic, getLang, t } from './i18n.js?v=116';
import { draft, grade } from './engine.js?v=116';
import { printPattern, printGrade, printGradeNested } from './print.js?v=116';
import { renderResult } from './render.js?v=116';
import {
  MEASUREMENTS, loadMeasurements, saveMeasurements, saveToCloset,
  loadProfiles, saveProfile, deleteProfile,
} from './store.js?v=116';
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat } from './vision-bridge.js?v=116';
