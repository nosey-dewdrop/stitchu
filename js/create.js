...
import { analyzePhoto, photoAvailable } from './analyze.js?v=130';
import { validateVision } from './spec-validate.js?v=130';
import { CONTRACT } from './contract.gen.js?v=130';
import { applyStatic, getLang, t } from './i18n.js?v=130';
import { draft, grade } from './engine.js?v=130';
import { printPattern, printGrade, printGradeNested } from './print.js?v=130';
import { renderResult } from './render.js?v=130';
import {
  MEASUREMENTS, loadMeasurements, saveMeasurements, saveToCloset,
  loadProfiles, saveProfile, deleteProfile,
} from './store.js?v=130';
import { pickGather, pickTiePlacement, pickCollar, pickBackOpening, pickLaceUpBack, pickWrapFront, pickHemSlit, pickRuffledStraps, pickPeplum, pickHemFlounce, pickPocket, pickCuff, pickHemShape, pickPlacket, pickBackDetail, pickExposedZip, pickBardot, pickCupSeam, pickYoke, pickBoxPleat, refreshSkirtLengthMM, applyMeasuredRatios, pickSkirtFullness } from './vision-bridge.js?v=130';
import { measureGarment } from './measure.js?v=130';
