...
import { analyzePhoto, photoAvailable } from './analyze.js?v=4';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=4';
import { draft } from './engine.js?v=4';
import { printPattern } from './print.js?v=4';
import { renderResult } from './render.js?v=4';
import {
