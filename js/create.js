...
import { analyzePhoto, photoAvailable } from './analyze.js?v=111';
import { validateVision } from './spec-validate.js?v=111';
import { CONTRACT } from './contract.gen.js?v=111';
import { applyStatic, getLang, t } from './i18n.js?v=111';
import { draft, grade } from './engine.js?v=111';
import { printPattern, printGrade, printGradeNested } from './print.js?v=111';
import { renderResult } from './render.js?v=111';
import {
