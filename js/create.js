...
import { analyzePhoto, photoAvailable } from './analyze.js?v=48';
import { applyStatic, getLang, mountLangToggle, t } from './i18n.js?v=48';
import { draft, grade } from './engine.js?v=48';
import { printPattern, printGrade, printGradeNested } from './print.js?v=48';
import { renderResult } from './render.js?v=48';
import {
