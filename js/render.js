...
import { fabricAdvice } from './fabrics.js?v=135';
import { getLang, t } from './i18n.js?v=135';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=135';
import { GUIDE_TR } from './guide-tr.js?v=135';
import { GLOSSARY } from './glossary.js?v=135';
import { appendSewingCompanion } from './sewing.js?v=135';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=135';
export { pathD, bounds };
