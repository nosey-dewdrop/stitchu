...
import { fabricAdvice } from './fabrics.js?v=112';
import { getLang, t } from './i18n.js?v=112';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=112';
import { GUIDE_TR } from './guide-tr.js?v=112';
import { GLOSSARY } from './glossary.js?v=112';
import { appendSewingCompanion } from './sewing.js?v=112';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=112';
export { pathD, bounds };
