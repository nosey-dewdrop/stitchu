...
import { fabricAdvice } from './fabrics.js?v=100';
import { getLang, t } from './i18n.js?v=100';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=100';
import { GUIDE_TR } from './guide-tr.js?v=100';
import { GLOSSARY } from './glossary.js?v=100';
import { appendSewingCompanion } from './sewing.js?v=100';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=100';
export { pathD, bounds };
