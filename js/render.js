...
import { fabricAdvice } from './fabrics.js?v=121';
import { getLang, t } from './i18n.js?v=121';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=121';
import { GUIDE_TR } from './guide-tr.js?v=121';
import { GLOSSARY } from './glossary.js?v=121';
import { appendSewingCompanion } from './sewing.js?v=121';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=121';
export { pathD, bounds };
