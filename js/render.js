...
import { fabricAdvice } from './fabrics.js?v=139';
import { getLang, t } from './i18n.js?v=139';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=139';
import { GUIDE_TR } from './guide-tr.js?v=139';
import { GLOSSARY } from './glossary.js?v=139';
import { appendSewingCompanion } from './sewing.js?v=139';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=139';
export { pathD, bounds };
