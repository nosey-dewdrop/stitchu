...
import { fabricAdvice } from './fabrics.js?v=122';
import { getLang, t } from './i18n.js?v=122';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=122';
import { GUIDE_TR } from './guide-tr.js?v=122';
import { GLOSSARY } from './glossary.js?v=122';
import { appendSewingCompanion } from './sewing.js?v=122';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=122';
export { pathD, bounds };
