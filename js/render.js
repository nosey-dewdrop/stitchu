...
import { fabricAdvice } from './fabrics.js?v=96';
import { getLang, t } from './i18n.js?v=96';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=96';
import { GUIDE_TR } from './guide-tr.js?v=96';
import { GLOSSARY } from './glossary.js?v=96';
import { appendSewingCompanion } from './sewing.js?v=96';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=96';
export { pathD, bounds };
