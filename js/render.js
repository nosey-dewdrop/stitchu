...
import { fabricAdvice } from './fabrics.js?v=140';
import { getLang, t } from './i18n.js?v=140';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=140';
import { GUIDE_TR } from './guide-tr.js?v=140';
import { GLOSSARY } from './glossary.js?v=140';
import { appendSewingCompanion } from './sewing.js?v=140';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=140';
export { pathD, bounds };
