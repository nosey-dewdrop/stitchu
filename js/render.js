...
import { fabricAdvice } from './fabrics.js?v=125';
import { getLang, t } from './i18n.js?v=125';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=125';
import { GUIDE_TR } from './guide-tr.js?v=125';
import { GLOSSARY } from './glossary.js?v=125';
import { appendSewingCompanion } from './sewing.js?v=125';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=125';
export { pathD, bounds };
