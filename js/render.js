...
import { fabricAdvice } from './fabrics.js?v=98';
import { getLang, t } from './i18n.js?v=98';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=98';
import { GUIDE_TR } from './guide-tr.js?v=98';
import { GLOSSARY } from './glossary.js?v=98';
import { appendSewingCompanion } from './sewing.js?v=98';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=98';
export { pathD, bounds };
