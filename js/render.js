...
import { fabricAdvice } from './fabrics.js?v=123';
import { getLang, t } from './i18n.js?v=123';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=123';
import { GUIDE_TR } from './guide-tr.js?v=123';
import { GLOSSARY } from './glossary.js?v=123';
import { appendSewingCompanion } from './sewing.js?v=123';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=123';
export { pathD, bounds };
