...
import { fabricAdvice } from './fabrics.js?v=111';
import { getLang, t } from './i18n.js?v=111';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=111';
import { GUIDE_TR } from './guide-tr.js?v=111';
import { GLOSSARY } from './glossary.js?v=111';
import { appendSewingCompanion } from './sewing.js?v=111';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=111';
export { pathD, bounds };
