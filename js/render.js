...
import { fabricAdvice } from './fabrics.js?v=116';
import { getLang, t } from './i18n.js?v=116';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=116';
import { GUIDE_TR } from './guide-tr.js?v=116';
import { GLOSSARY } from './glossary.js?v=116';
import { appendSewingCompanion } from './sewing.js?v=116';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=116';
export { pathD, bounds };
