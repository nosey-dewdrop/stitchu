...
import { fabricAdvice } from './fabrics.js?v=105';
import { getLang, t } from './i18n.js?v=105';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=105';
import { GUIDE_TR } from './guide-tr.js?v=105';
import { GLOSSARY } from './glossary.js?v=105';
import { appendSewingCompanion } from './sewing.js?v=105';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=105';
export { pathD, bounds };
