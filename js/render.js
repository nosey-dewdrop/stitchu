...
import { fabricAdvice } from './fabrics.js?v=128';
import { getLang, t } from './i18n.js?v=128';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=128';
import { GUIDE_TR } from './guide-tr.js?v=128';
import { GLOSSARY } from './glossary.js?v=128';
import { appendSewingCompanion } from './sewing.js?v=128';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=128';
export { pathD, bounds };
