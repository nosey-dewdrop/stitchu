...
import { fabricAdvice } from './fabrics.js?v=131';
import { getLang, t } from './i18n.js?v=131';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=131';
import { GUIDE_TR } from './guide-tr.js?v=131';
import { GLOSSARY } from './glossary.js?v=131';
import { appendSewingCompanion } from './sewing.js?v=131';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=131';
export { pathD, bounds };
