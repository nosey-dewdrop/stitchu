...
import { fabricAdvice } from './fabrics.js?v=95';
import { getLang, t } from './i18n.js?v=95';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=95';
import { GUIDE_TR } from './guide-tr.js?v=95';
import { GLOSSARY } from './glossary.js?v=95';
import { appendSewingCompanion } from './sewing.js?v=95';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=95';
export { pathD, bounds };
