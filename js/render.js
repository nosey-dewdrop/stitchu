...
import { fabricAdvice } from './fabrics.js?v=108';
import { getLang, t } from './i18n.js?v=108';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=108';
import { GUIDE_TR } from './guide-tr.js?v=108';
import { GLOSSARY } from './glossary.js?v=108';
import { appendSewingCompanion } from './sewing.js?v=108';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=108';
export { pathD, bounds };
