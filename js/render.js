...
import { fabricAdvice } from './fabrics.js?v=115';
import { getLang, t } from './i18n.js?v=115';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=115';
import { GUIDE_TR } from './guide-tr.js?v=115';
import { GLOSSARY } from './glossary.js?v=115';
import { appendSewingCompanion } from './sewing.js?v=115';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=115';
export { pathD, bounds };
