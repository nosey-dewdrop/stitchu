...
import { fabricAdvice } from './fabrics.js?v=152';
import { getLang, t } from './i18n.js?v=152';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=152';
import { GUIDE_TR } from './guide-tr.js?v=152';
import { GLOSSARY } from './glossary.js?v=152';
import { appendSewingCompanion } from './sewing.js?v=152';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=152';
export { pathD, bounds };
