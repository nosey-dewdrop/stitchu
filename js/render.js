...
import { fabricAdvice } from './fabrics.js?v=144';
import { getLang, t } from './i18n.js?v=144';
import { missingFeatures, MISSING_STRINGS } from './missing.js?v=144';
import { GUIDE_TR } from './guide-tr.js?v=144';
import { GLOSSARY } from './glossary.js?v=144';
import { appendSewingCompanion } from './sewing.js?v=144';
...
import { pathD, bounds, packPieces, usedCells, sheetInner, PAGE_W, PAGE_H } from './sheet.js?v=144';
export { pathD, bounds };
