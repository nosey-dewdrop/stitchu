...
import * as koken from './provenance.js?v=144';

import { pathD, bounds } from './sheet.js?v=144';
import * as sheet from './sheet.js?v=144';
import { makePdfCore } from '../lib/pdf-core.js?v=144';
import { dxfRecipe, dxfSpec, flatDrawing } from './engine.js?v=144';
...
import { arkaDurumu } from '../lib/arka-koken.js?v=144';
