...
| **3 — DERİNLİK** | F4 → F6 → F7 → F8 → F9 | **F4 ✅ GEÇTİ** (`F4-yesil`) — ⭐ bu koşuda **İLK KEZ bir miras kırmızı ÖLDÜ: 6 → 5** (K23/K56) ve **H6 on iki fazdır ilk kez bir SAYI** (K59). ← **şimdi buradayız**: sıra **F6 (KUMAŞ)**, kart `GECE7/F6.md`. Hanesi **H5'in PAYI** (§3.6) — ⚠ **payda 5'tir ve büyütmek ŞART DEĞİL**, sebebi K59'da üç maddeyle ölçüldü |
...
| **F6** | — | açılmadı | — | 🔜 **SIRADAKİ** — kart `GECE7/F6.md`, hanesi **H5'in PAYI**, asıl işi **üç kumaş → üç ölçülebilir farklı kalıp** |
