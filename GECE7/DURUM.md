...
| **3 — DERİNLİK** | F4 → F6 → F7 → F8 → F9 | ← **şimdi buradayız**: sıra **F4 (MANKEN BEDENİ)**, kart `GECE7/F4.md`. Hanesi **H6** (§3.6, bugün **ÖLÇEMEDİM**); asıl işi **K23** (`body_length` sapması **−28.7714 mm = %−3.7979**, eşik %1.5) + manken çizelgesinin **ilanı** + `flat_artifact_census`'ün **tek ihlalini** kökten kapatmak. §3.11 gereği okuma listesine **§2** eklendi |
...
| **F4** | — | açılmadı | — | 🔜 **HALKA 3 AÇILDI** — kart `GECE7/F4.md`, hanesi **H6**, asıl işi **K23** |

## ✅ HAKEMİN HÜKMÜ — F5-E (`dc5bb36`, etiket `F5E-yesil`)
