...
| **2 — MOTOR** | F3 ⇄ F5 (alt-kartlar) | ← **şimdi buradayız**: F3 ✅ · **F5-A ✅** · **F5-B ✅** · **F5-C ✅ GEÇTİ** (`F5C-yesil`), sıra **F5-D** — ⚠ **operatör kartı DEĞİL, ÜRÜN YOLUNA BAĞLAMA** (K46), kart `GECE7/F5D.md`. **F5 SÜRÜYOR: motorda 3 operatör. Kapanış eşiği "15 operatör" DEĞİL, mühürlü paydanın KUYRUĞU (H8-ifade 0/5) → operatör alt-kartı 12 değil 5 (K45)** |
...
| **F5-D** | — | açılmadı | — | 🔜 kart `GECE7/F5D.md` — ⚠ **operatör kartı DEĞİL: ÜRÜN YOLUNA BAĞLAMA** (borç 45+49+51, K46). `op.attach` **F5-E'ye kaydı** |
