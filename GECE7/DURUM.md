...
| **2 — MOTOR** | F3 ⇄ F5 (alt-kartlar) | ← **şimdi buradayız**: F3 ✅ · **F5-A ✅** · **F5-B ✅** · **F5-C ✅** · **F5-D ✅ GEÇTİ** (`F5D-yesil`), sıra **F5-E** — ⚠ **operatör kartı DEĞİL, KÖPRÜ** (`SeamPlan` ⇄ `DraftedPattern`, K47), kart `GECE7/F5E.md`. **F5 SÜRÜYOR: motorda 3 operatör. Kapanış eşiği K48'de ÜÇ ŞARTLI oldu — kuyruk boşalacak + H5'in paydası bir kez büyüyecek + H4 sayı ya da kapı. F5-E'nin TAVANI İKİ TUR; ikinci turda da payda büyümezse F5 DURUR ve Halka 3 F4'ten açılır.** `op.attach` **F5-F'ye kaydı** |
...
| **F5-E** | — | açılmadı | — | 🔜 kart `GECE7/F5E.md` — ⚠ **operatör kartı DEĞİL: KÖPRÜ** (`SeamPlan` ⇄ `DraftedPattern`, borç 62+51, K47/K48). `op.attach` **F5-F'ye kaydı** |
