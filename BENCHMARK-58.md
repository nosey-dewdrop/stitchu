...
Durum (motor + eşleştirme): **26→29/54 TAM KALIP — queue #3 (ruffled straps) sonrası +3, 2026-07-17, patch 3.1.**
...
| 9c | **Peplum + hem slit** (YENİ 3-4. ÖNCELİK, marjinal +2+2) | Peplum = bele oturan aşağı açılan pano (pointed hem dahil); hem slit = etek yırtmacı. İki küçük post-pass. | hem slit BİTTİ (M1); peplum bekliyor | — |
