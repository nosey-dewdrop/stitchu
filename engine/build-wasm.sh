...
em++ -O2 -std=c++17 -fexceptions -sDISABLE_EXCEPTION_CATCHING=0 \
  src/geometry.cpp src/bodice.cpp src/skirt.cpp src/ruffle.cpp src/keyhole.cpp src/placket.cpp src/tie.cpp src/collar.cpp src/gather.cpp src/openback.cpp src/laceupback.cpp src/wrapfront.cpp src/slit.cpp src/strap.cpp src/peplum.cpp src/cupseam.cpp src/yoke.cpp src/boxpleat.cpp src/pocket.cpp src/neckext.cpp src/cuff.cpp src/hem.cpp src/shoulder.cpp src/buttonrow.cpp src/exposedzip.cpp src/backdetail.cpp src/offshoulder.cpp src/sleeve.cpp src/garment.cpp src/wearability.cpp src/validator.cpp \
  wasm/bindings.cpp \
  -lembind \
