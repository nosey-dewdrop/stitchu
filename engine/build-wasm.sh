...
mkdir -p dist
em++ -O2 -std=c++17 \
  src/geometry.cpp src/bodice.cpp src/skirt.cpp src/ruffle.cpp src/keyhole.cpp src/placket.cpp src/tie.cpp src/collar.cpp src/sleeve.cpp src/garment.cpp src/validator.cpp \
  wasm/bindings.cpp \
  -lembind \
