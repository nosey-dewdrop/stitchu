...
writeFileSync(join(OUT, 'id82-crew-boxy-crop-a4.pdf'), buf);
...
info.push(`OUTPUT: id82-crew-boxy-crop-a4.pdf — ${totalPages} pages (cover + test square + ${sheets.length} pattern sheet(s) + gluing/sew guide)`);
