// KOSU/siluet-kalip.mjs — SILUET -> KALIP (0-K.10.e). Flat genislikleri kaliba HEDEF, pens ve bolluk oradan.
//   node KOSU/siluet-kalip.mjs <set> [no...]
...
import { noktaBeden } from './siluet-ciz.mjs';
...
for (const no of nolar) {
  ...
  const taban = eski.tabanGraf || 'KOSU/ciktilar/graf-ilk/graf.json';
  ...
  yeni.push(`cizim flat = KOSU/siluet-ciz.mjs (okuma KOSU/onbellek/siluet-${sha.slice(0, 12)}….json; motor flat'e girmez)`);
