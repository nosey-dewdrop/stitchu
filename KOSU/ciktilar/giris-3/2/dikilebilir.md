...
| 8 | `subdivide` | `{"panel":"arka_beden","edge":"cb","fractions":[0.5064]}` | askili ust: govde koltukalti hizasinda kesilir: CB'de kesim noktasi |
| 9 | `subdivide` | `{"panel":"arka_beden","edge":"armhole_back.1","fractions":[0.147]}` | askili ust: govde koltukalti hizasinda kesilir: arka kol oyugunda kesim noktasi |
| 10 | `split` | `{"panel":"arka_beden","vertexA":"cb.2","vertexB":"armhole_back.1.2","panelA":"arka_beden_alt","panelB":"arka_beden_ust","seam":"ust_arka","seamRatio":1}` | askili ust: govde koltukalti hizasinda kesilir: arka ust govde ayri panel |
| 11 | `drop` | `{"panel":"arka_beden_ust","finish":"faced"}` | askili ust: govde koltukalti hizasinda kesilir: arka ust govde kalkar |
...
| 14 | `addPanel` | `{"onto":"on_beden_alt","panel":{"id":"aski_on","edges":[{"id":"ic","kind":"cut","role":"strap","from":{"landmark":"landmark.bustLine","xOf":"ringQuarter","ring"…` | ince aski (12 mm), gogus ucu hizasindan omuza |
| 15 | `addPanel` | `{"onto":"arka_beden_alt","panel":{"id":"aski_arka","edges":[{"id":"ic","kind":"cut","role":"strap","from":{"landmark":"landmark.bustLine","xOf":"ringQuarter","r…` | ince aski (12 mm), gogus ucu hizasindan omuza |
| 16 | `extendTo` | `{"panel":"on_etek","edge":"hem_front","yLandmark":"landmark.knee","yOffsetMM":60}` | etek ucu diz alti (~6 cm) |
| 17 | `extendTo` | `{"panel":"arka_etek","edge":"hem_back","yLandmark":"landmark.knee","yOffsetMM":60}` | etek ucu diz alti (~6 cm) (arka ayni) |
| 18 | `flare` | `{"panel":"on_etek","edge":"hem_front","factor":1.45}` | A-line etek: etek ucu belirgin acik |
| 19 | `flare` | `{"panel":"arka_etek","edge":"hem_back","factor":1.45}` | A-line etek: etek ucu belirgin acik (arka ayni) |
...
| cikti | durum | bayt |
|---|---|---|
| flat.svg | OK (data-ops=19) | 19070 |
| flat.png | OK | 43478 |
| kalip-36.svg | OK | 12164 |
| kalip-36.png | OK | 37675 |
