...
Motor (`grafuygula`) taban grafa bu 26 emri sirayla uyguladi; cizici (`grafciz --ops`) ops SONRASI grafi cizdi.
...
| 8 | `subdivide` | `{"panel":"arka_beden","edge":"cb","fractions":[0.4834]}` | kare ust kenar: govde koltukalti hizasinda kesilir: CB'de kesim noktasi |
| 9 | `subdivide` | `{"panel":"arka_beden","edge":"armhole_back.1","fractions":[0.257]}` | kare ust kenar: govde koltukalti hizasinda kesilir: arka kol oyugunda kesim noktasi |
| 10 | `split` | `{"panel":"arka_beden","vertexA":"cb.2","vertexB":"armhole_back.1.2","panelA":"arka_beden_alt","panelB":"arka_beden_ust","seam":"ust_arka","seamRatio":1}` | kare ust kenar: govde koltukalti hizasinda kesilir: arka ust govde ayri panel |
| 11 | `drop` | `{"panel":"arka_beden_ust","finish":"faced"}` | kare ust kenar: govde koltukalti hizasinda kesilir: arka ust govde kalkar |
| 12 | `sew` | `{"seam":"arka_orta_beden","a":[{"panel":"arka_beden_alt","edge":"cb.2"}],"b":[{"panel":"arka_beden_alt","edge":"cb.2"}],"reverse":true,"ratio":1}` | arka orta kapanma: drop ile dusen arka orta dikisi yeniden (cb.2 kendi aynasiyla) |
...
| 14 | `subdivide` | `{"panel":"on_beden_alt","edge":"cf.2","fractions":[0.3935]}` | gogus alti dikis: CF |
| 15 | `subdivide` | `{"panel":"on_beden_alt","edge":"side_front","fractions":[0.6768]}` | gogus alti dikis: yan |
| 16 | `split` | `{"panel":"on_beden_alt","vertexA":"cf.2.2","vertexB":"side_front.2","panelA":"on_beden_alt2","panelB":"on_beden_ust2","seam":"gogus_alti_on","seamRatio":1}` | gogus alti dikis |
| 17 | `subdivide` | `{"panel":"arka_beden_alt","edge":"cb.2","fractions":[0.3935]}` | gogus alti dikis: CB |
| 18 | `subdivide` | `{"panel":"arka_beden_alt","edge":"side_back","fractions":[0.6768]}` | gogus alti dikis: arka yan |
| 19 | `split` | `{"panel":"arka_beden_alt","vertexA":"cb.2.2","vertexB":"side_back.2","panelA":"arka_beden_alt2","panelB":"arka_beden_ust2","seam":"gogus_alti_arka","seamRatio":…` | gogus alti dikis (arka) |
| 20 | `gather` | `{"panel":"on_beden_ust2","edge":"gogus_alti_on.b","ratio":1.25}` | gogus buzgusu: ust parcanin alt kenari 1.25 kat |
| 21 | `addPanel` | `{"onto":"on_beden_ust2","panel":{"id":"aski_on","edges":[{"id":"ic","kind":"cut","role":"strap","from":{"landmark":"landmark.bustLine","xOf":"ringQuarter","ring…` | genis aski (45 mm), buzgulu |
| 22 | `addPanel` | `{"onto":"arka_beden_ust2","panel":{"id":"aski_arka","edges":[{"id":"ic","kind":"cut","role":"strap","from":{"landmark":"landmark.bustLine","xOf":"ringQuarter","…` | genis aski (45 mm), buzgulu |
| 23 | `extendTo` | `{"panel":"on_etek","edge":"hem_front","yLandmark":"landmark.hip","yOffsetMM":200}` | mini: kalca + ~20 cm |
| 24 | `extendTo` | `{"panel":"arka_etek","edge":"hem_back","yLandmark":"landmark.hip","yOffsetMM":200}` | mini: kalca + ~20 cm (arka ayni) |
| 25 | `flare` | `{"panel":"on_etek","edge":"hem_front","factor":1.3}` | buzgulu etek acik |
| 26 | `flare` | `{"panel":"arka_etek","edge":"hem_back","factor":1.3}` | buzgulu etek acik (arka ayni) |
...
| cikti | durum | bayt |
|---|---|---|
| flat.svg | OK (data-ops=26) | 17744 |
| flat.png | OK | 36704 |
| kalip-36.svg | OK | 15404 |
| kalip-36.png | OK | 26788 |
